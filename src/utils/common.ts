 ...
 * @returns {string}
 */
export function formatDateTime(date: Date, ignoreStartOfDayTime: boolean = false): string {
    if (ignoreStartOfDayTime && date.getHours() === 0 && date.getMinutes() === 0 && date.getSeconds() === 0) {
